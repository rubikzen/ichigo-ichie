...
// V500: keep the collection shell lightweight while loading the interactive
// sorting, review summaries and ProductCard graph as a separate client chunk.
const ShopCollectionProducts = dynamic(() =>
  import("@/components/ShopCollectionProducts").then(
    (module) => module.ShopCollectionProducts,
  ),
);
