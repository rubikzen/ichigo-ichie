...
export default function AdminLoginPage() {
  ...
  return <section className="admin-login-page"><div className="admin-login-card"><img src="/brand-mark.svg" alt="" width="58" height="58" /><p className="eyebrow">ESPACE PRIVÉ</p><h1>Administration</h1><p>Gérez les produits, le menu, les images et les commandes.</p>
