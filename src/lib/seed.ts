...
export const seedProducts: Product[] = [
  {
    ...
    slug: "matcha-latte",
    category_id: "cat-matcha-drinks",
    type: "drink",
    name_fr: "Matcha Latte",
    ...
    origin: "Préparé à Nice",
    cultivar: "Matcha japonais",
    badge: "Classique",
    base_price: 6.5,
    stock: 99,
    pickup_only: true,
    ...
    ideal_for: ["Matcha latte", "Débutant"],
    variants: [],
  ...
  },
  {
    ...
    sort_order: 2,
    image_url: "/product-placeholder.svg",
    ideal_for: ["Matcha latte", "Boisson fruitée"],
    variants: [],
  ...
  },
  {
    ...
    category_id: "cat-matcha-drinks",
    type: "drink",
    name_fr: "Mango Matcha",
    name_en: "Mango Matcha",
    ...
    sort_order: 3,
    image_url: "/product-placeholder.svg",
    ideal_for: ["Matcha latte", "Été"],
    variants: [],
    option_groups: [{ ...tempOptions, values: [tempOptions.values[0]] }, milkOptions, sugarOptions, toppings],
  },
  {
    id: "drink-coconut-cloud",
    slug: "matcha-coconut-cloud",
    category_id: "cat-matcha-drinks",
    type: "drink",
    name_fr: "Matcha Coconut Cloud",
    name_en: "Matcha Coconut Cloud",
    ...
    featured: true,
    sort_order: 4,
    image_url: "/products/matcha-coconut-cloud.webp",
    ideal_for: ["Rafraîchissant", "Été"],
    variants: [],
  ...
  },
  {
    ...
    featured: true,
    sort_order: 1,
    image_url: "/products/matcha-lava.webp",
    ideal_for: ["Dessert", "Matcha intense"],
    variants: [],
    option_groups: [],
  },
  {
    ...
    featured: true,
    sort_order: 1,
    image_url: "/products/matcha-packaging.webp",
    ideal_for: ["Usucha", "Matcha latte", "Débutant", "Matcha quotidien"],
    variants: [
      {
        id: "sen-30",
        product_id: "matcha-sen",
        name: "30 g",
        packaging: "can",
        weight: "30 g",
        price: 24.9,
  ...
  {
    id: "accessory-chasen",
    slug: "chasen-takayama",
    category_id: "cat-accessories",
    type: "accessory",
    name_fr: "Chasen Takayama",
    name_en: "Takayama Chasen",
